...
---
Follow the .ai/ retrieval protocol (memory loading contract §2 in `.ai-protocol/meta/memory.md` + `.ai/index.md` routing; already in baseline context — no need to reload).
...
2. From index: follow the .ai/ retrieval protocol (memory loading contract) to explore .ai/
